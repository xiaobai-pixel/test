...
def gtg_processing(sound, sampling_rate, log_constant=1e-80, dB_threshold=-50.0, freq_min=400, freq_max=6000, chan=21, frame_len=64, frame_overlap=32):
    """ Convert sound into gammatonegram, with amplitude in decibels"""
    sxx, center_frequencies = gammatonegram(sound, sr=sampling_rate, fmin=freq_min, fmax=freq_max, N=chan, twin=frame_len/sampling_rate, thop=frame_overlap/sampling_rate)
...
def gtgplot(sxx, center_frequencies, sample_duration, sampling_rate,
            dB_threshold=1, dB_max=-1, t_space=50, f_space=10):
    """Plot gammatonegram"""
